...
#define MISO  GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_6)//读取PA6
#define GDO0  GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_5)//读取PC5

//#define	GDO0	{GPIO_ReadInputPin(GDO0_PORT,GDO0_PIN)}
//#define	MISO	{GPIO_ReadInputPin(MISO_PORT,MISO_PIN)}
